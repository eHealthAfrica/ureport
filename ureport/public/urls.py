...
from .views import CountriesView, Chooser, AdditionalMenu, AWSHealth
...
urlpatterns = patterns('',
    ...
    (r'^added/$', AdditionalMenu.as_view(), {}, 'public.added'),
    (r'^health/$', AWSHealth.as_view(), {}, 'public.aws_health'),
